...
namespace BLL.Interfaces
{
    public interface IUserListService
    {
        ...
        public Task<(List<User>, int totalRecords)> GetUsersAsync(int pageIndex, int pageSize);
        ...
        public Task<UserListViewModel> GetUsersListViewModelAsync(int pageIndex, int pageSize);
