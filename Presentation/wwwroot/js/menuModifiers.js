      ...
      try {
        ...
        $.ajax({
          ...
          data: JSON.stringify({
            ...
            ModifierGroupDescription: description,
          ...
          success: function (data) {
            if (data.success) {
              ...
              $.ajax({
                ...
                data: {
                  modifierGroupId: modifierGroupId,
                  pageIndex: pageIndexOfModifierFromModal,
                  pageSize: pageSizeOfModifierFromModal,
                },
                success: function (data) {
  ...
  try {
    ...
    if (selectedModifiersGroupsAddModifier.includes(modifierGroupId)) {
      selectedModifiersGroupsAddModifier =
        selectedModifiersGroupsAddModifier.filter((x) => x !== modifierGroupId);
            ...
            if (data.success) {
              ...
              $.ajax({
                ...
                data: {
                  pageIndex: pageIndexOfModifierFromModal,
                  pageSize: pageSizeOfModifierFromModal,
                  modifierGroupId: $("#modifierGroupId21").val(),
                },
                success: function (data) {
...
function showSearchBarModifier() {
  try {
    document
      .getElementById("mobile-search-bar-modifier")
